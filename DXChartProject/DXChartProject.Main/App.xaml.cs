...
using DXChartProject.Main.Properties;
using DXChartProject.Main.ViewModels;
using DXChartProject.Main.Views;
using DXChartProject.Modules.ViewModels;
using DXChartProject.Modules.Views;
using System.ComponentModel;
using System.Windows;
using AppModules = DXChartProject.Common.Modules;

namespace DXChartProject.Main
{
